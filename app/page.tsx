      ...
      <div className='bg-white'>
        ...
        <div className='mt-10 bg-white'>
          <div className='flex justify-center items-center flex-col flex-wrap gap-12'>
            <div className='flex justify-center items-center flex-col relative md:flex-row gap-10 px-6'>
              <Image src={Passionate} alt='passionate'/>
              <Image src={SmallCircle} alt='circle' className='absolute top-0 md:left-7'/>
              <div>
              <h2 className='text-center text-xl tracking-widest mt-6 md:text-left'>PASSIONATE</h2>
              <p className='text-center px-6 mt-6 md:text-left md:px-0'>
            ...
            <div className='flex justify-center items-center flex-col relative md:flex-row gap-10 px-6'>
              ...
              <Image src={SmallCircle} alt='circle' className='absolute top-0 md:left-7'/>
              <div>
              <h2 className='text-center text-xl tracking-widest mt-6 md:text-left'>RESOURCEFUL</h2>
              <p className='text-center px-6 mt-6 md:text-left md:px-0'>
            ...
            <div className='flex justify-center items-center flex-col relative md:flex-row gap-10 px-6'>
              ...
              <Image src={SmallCircle} alt='circle' className='absolute top-0 md:left-7'/>
              <div>
              <h2 className='text-center text-xl tracking-widest mt-6 md:text-left'>FRIENDLY</h2>
              <p className='text-center px-6 mt-6 md:text-left md:px-0'>
...
export function Talk(){
  return (
    ...
    <div className='bg-peach relative w-80 h-96 flex justify-center items-center rounded-lg text-white flex-col md:w-[43rem] md:h-80'>
